...
const renderLectureMaterials = () => {
  ...
  // // Function to handle deletion of lecture material
  // const handleDeleteLectureMaterial = async (materialId, courseOfferingId) => {
  //   try {
  //     const response = await fetch(`${config.BASE_URL}/api/Course/DeleteContent/${materialId}`, {
  //       method: 'DELETE',
  //       headers: {
  //         'Content-Type': 'application/json',
  ...
  //     if (response.ok) {
  //       // Update the courseDetails state to remove the deleted material
  //       setCourseDetails(prevDetails => ({
  //         ...prevDetails,
  //         lectureMaterials: prevDetails.lectureMaterials.filter(material => material.id !== materialId)
  //       }));
  //       console.log('Lecture material deleted successfully');
  //     } else {
  ...
  <View style={[styles.tableContainerLM]}>
     ...
     <View style={[styles.HeaderContainer, { 
      ...
      <Text style={[styles.HeaderText, { 
          ...
          Lecture Material 
               {/* {'\n'} */}
                  {/* <Text style={{ fontSize: isMobile ? 10 : 14 , color:'grey',backgroundColor:'yellow',textAlign:'left' , width: '100%',marginLeft:10 }}>
                   (<Text style={{ fontWeight: 'bold' }}>Note :</Text> Click on specific week to view it's details.)
                   </Text> */}
...
<TooltipWrapper tooltipText="Click to Add New Content">
      ...
      <TouchableOpacity
        ...
        style={[
          ...
          // { alignSelf: isMobile ? 'center' : 'flex-end', marginTop: isMobile ? 10 : 0 }
        ]}
        onPress={() => {
...
{/* //styles.tableWrapperLM, { width: '100%',flex: 1, } */}
    <View style={[styles.tableWrapper]}>

{/* <View style={[styles.tableRowLM, styles.weekTableHeaderLM, { width: '100%',backgroundColor:"lightyellow" }]}>
      <Text style={{ fontSize: isMobile ? 10 : 14 , color:'red',textAlign:'left' , width: '100%',paddingHorizontal: 15 }}>
            <Text style={{ fontWeight: 'bold' }}>Note:</Text> Click on specific learning week to view details.
            </Text>
      </View> */}
      ...
      <View style={[styles.tableRowLM, styles.weekTableHeaderLM, { width: '100%' }]}>
         <Text style={[styles.tableCellLM, styles.weekHeaderTextLM, { 
                    width: isMobile ? '10%' : '5%', 
     ...
     > */}
      ...
      {/* [styles.tableWrapperLM, { width: '100%' } */}
              ...
              >
                ...
                <View style={[{ 
                                  ...
                                  <Image
                                    ...
                                    style={[styles.dropdownIcon, { width: isMobile ? 16 : 20, height: isMobile ? 16 : 20 }]}
                                  />
                                </View>
                   <Text style={[
                    styles.tableCellLM, 
                  ...
                  ,Platform.OS === 'web' && !isMobile && hoveredWeek === week && styles.weekHoverEffect
                  , expandedWeeks[week] && {backgroundColor:'lightgreen'}
                ]}>
                  {week}
                </Text>
...
<View style={[styles.tableRowLM, styles.tableHeaderexpanded]}>
    <Text style={[styles.tableCellLM, styles.tableHeaderTextExpanded, { width: isMobile ? '5%' : '5%' }]}> S# </Text>
    {/* <Text style={[styles.tableCellLM, styles.tableHeaderTextExpanded, { width: isMobile ? '20%' : '20%', fontSize: isMobile ? 10 : 12 }]}> Learning Week </Text> */}
    <Text style={[styles.tableCellLM, styles.tableHeaderTextExpanded, { width: isMobile ? '25%' : '25%' }]}> Title </Text>
    <Text style={[styles.tableCellLM, styles.tableHeaderTextExpanded, { width: isMobile ? '45%' : '45%'}]}> Description </Text>
    <Text style={[styles.tableCellLM, styles.tableHeaderTextExpanded, { width: isMobile ? '10%' : '10%' , textAlign:'center'}]}> Attachment </Text>
    <Text style={[styles.tableCellLM, styles.tableHeaderTextExpanded, { width: isMobile ? '15%' : '15%', textAlign:'center' }]}> Actions </Text>
</View>
                  ...
                  {groupedMaterials[week].materials.map((material, index) => (
                    <View key={material.id}
                     ...
                     onLayout={() => console.log(`Rendering material: ${material.id} in week: ${week}`)} >
                        <Text style={[styles.tableCellExpanded, { width: isMobile ? '5%' : '5%'  }]}>
                           {index + 1}. </Text>
                              {/* <Text style={[styles.tableCellExpanded, { width: '20%', fontSize: isMobile ? 12 : 16 }]}
                                  accessible={true} accessibilityLabel={`Description ${material.learningWeek || 'No Week Provided'}`}
                                  numberOfLines={2} ellipsizeMode="tail" > {material.learningWeek || '-'} </Text> */}
                      <Text style={[styles.tableCellExpanded, { width: '25%' }]}
                      ...
                      <Text style={[styles.tableCellExpanded, { width: '45%' }]}
                        accessible={true} accessibilityLabel={`Description ${material.description || 'No description'}`}
                        numberOfLines={2} ellipsizeMode="tail" >
                        {material.description || '-'}
                        {/* {material.isAttachment?'Yes':'No'}  */}
                        </Text>


                 <View style={[styles.tableCellExpanded, {width: isMobile ? '10%' : '10%', justifyContent: 'center', alignItems: 'center'}]}>
  {/* No Link & No attachment Case - Disabled interaction */}
  {!material.isURL && !material.file && !material.isAttachment && (
    <View style={[styles.actionButtonLM, styles.editButtonLM, {padding:5, backgroundColor:"transparent"}]}>
  ...
  {material.isURL && !material.isAttachment && (material.file) ? (
    ...
    <TouchableOpacity 
      ...
      style={[styles.actionButtonLM, styles.editButtonLM, {padding:5, backgroundColor:"lightblue"}]} 
      onPress={async () => {
        try {
...
try {
  ...
  return;
    ...
    >
      {/* <Text style={[styles.tableCellExpanded, {
    ...
    <TouchableOpacity 
      ...
      accessibilityRole="button" 
      style={[styles.actionButtonLM, styles.editButtonLM, {padding:5, backgroundColor:"lightgreen"}]} 
      onPress={async () => {
        ...
        try {
          ...
          if (filepath) {
            ...
            //Alert.alert('Error', 'No file specified');
            //return;
       ...
       // link.download = material.file || 'download';
        //document.body.appendChild(link);
        //link.click();
        ...
        if (!filepath) {
         //if file path is null then call API method to download content
...
console.log("Downloading API method call for current course ID "+courseOfferingID);
         //Call Method to call Download API to 
    ...
    >
      ...
      {/* <Text style={{color: 'white', fontSize: isMobile ? 10 : 12, textAlign: 'center', fontWeight: 'bold'}}></Text> */}
    </TouchableOpacity>
...
<View style={[styles.tableCellExpanded, {width: isMobile ? '15%' : '15%', flexDirection: 'row', justifyContent: 'center'}]}>

<TooltipWrapper tooltipText="Click to Edit Content">
  <TouchableOpacity accessible={true} accessibilityLabel={`Edit ${material.title}`} accessibilityRole="button" style={[styles.actionButtonLM, styles.editButtonLM, {padding:5}]} onPress={() => { setModalType('lectureMaterial'); setModalInitialData(material); setModalVisible(true); }}>
...
<TooltipWrapper tooltipText="Click to delete content">
  <TouchableOpacity accessible={true} accessibilityLabel={`Delete ${material.title}`} accessibilityRole="button" style={[styles.actionButtonLM, styles.deleteButtonLM, {padding:5}]} 
  onPress={() => { 
...
//       'Confirm Delete\n\nAre you sure you want to delete course content ?'
//     );
//     if (ok) {
//       handleDelete_CourseContent(material.id, selectedCourse?.courseOfferingID);
//     }
...
//           onPress: () => handleDelete_CourseContent(material.id, selectedCourse?.courseOfferingID),
//         },
//       ],
...
if(Allow_Message_Sending)
{
 ...
 setShowAlertPopup(true);
  ...
  // const handle_ViewStudentMessages = async (studentId) => {
  //   const messages = [...]; // Your API call or mock data
  //   setSelectedStudentMessages(messages);
  //   console.log('Updated messages:', messages); // Debug log
  //   setMessageHistoryModalVisible(true);
  // };
...
const renderStudentList = () => {
  ...
  //  // Handle view messages button press
  // const handle_ViewStudentMessages = async (studentId) => {
  //   // Mock fetch for messages - replace with actual API call
  //   const messages = [
  //     {
  //       For_Student_ID: studentId,
  //       Title: 'Attendance Related',
  //       Description: 'Missed last two classes',
  //       IsGeneralMessage: 0,
  //       IsCourseSpecificMsg: 1,
  //       Message_Level: 'High Priority',
  //       IsViewed: 0,
  //       IsAcknowledged: 0,
  //     },
  //   ];
...
const handle_ViewStudentMessages = async (studentId) => {
  try {
    ...
    if (!token) {
      //Alert.alert('Error', 'No auth token found.');
         ...
         setPopupAlertType('error');
      setPopupAlertTitle('Verification'); // Set custom title
    ...
    console.error('Error fetching messages:', error);
    //Alert.alert('Error', 'Unexpected error while fetching messages.');

       setPopupAlertType('error');
      setPopupAlertTitle('Error'); // Set custom title
      setPopupAlertMessage("Exception occured while fetching messages.");
      setPopupAlertButtons([
        { text: 'Ok'
          , onPress: () => setShowAlertPopup(false) 
  ...
  // // Handle modal submit (save to Messages_Students table)
  // const handle_MessageSendingToStudent = async () => {
  //   const student = courseDetails.students.find((s) => s.id === selectedStudentId);
  //   if (student) {
  //     const messageData = {
  ...
  //       Title: messageTitle,
  //       Description: messageDescription,
  //       IsGeneralMessage: 0, // Set to 0 (No) as per requirement
  //       IsCourseSpecificMsg: 1, // Set to 1 (Yes) as per requirement
  //       Message_Level: messageLevel,
  //       IsViewed: 0, // Default to 0 (No)
  //       IsAcknowledged: 0, // Default to 0 (No)
  //     };
  //     // Replace with actual API call to save to Messages_Students table
  ...
  return (
    <View style={[styles.tableContainerLM]}>
      {/* Header with Search Bar */}
       <View style={[styles.HeaderContainer]}>
              ...
              <Text style={[styles.HeaderText]}>
               ...
               {/* <View style={[styles.searchContainer, isMobile && { width: '100%', justifyContent: 'center', paddingVertical: 8 }]}> */}
                              {/* <TextInput
                                style={[styles.searchInput, isMobile && { fontSize: 14, height: 36, paddingVertical: 8 }]}
                              ...
                              /> */}
                               ...
                               <TextInput
                                ...
                                accessibilityLabel="Search students"
                                        ...
                                        />
                              {/* <TouchableOpacity
                                style={[styles.icon, isMobile && { padding: 8 }]}
                                accessible={true}
                              > */}
                                {/* <Image
                                  source={images.search}
                                  style={{ width: isMobile ? 18 : 27, height: isMobile ? 18 : 25, marginTop: 2, tintColor: '#fff' }}
                                /> */}
                              {/* </TouchableOpacity> */}
                            {/* </View> */}
                          </View>
      ...
      <View style={[styles.tableWrapper]}>
        {/* Fixed Table Header */}
        <View style={[styles.tableRow, styles.tableHeader, { width: '100%', paddingRight: Platform.OS === 'web' ? 16 : 0 }]}>
          <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 0.6 : 0.8,}]}>
                      S No.
                    </Text>
                    <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 1.2 : 1,}]}>
                      Roll No
                    </Text>
                    <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 1.8 : 1.5,}]}>
                      Name
                    </Text>
                     <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 1.2 : 1,}]}>
                      Class Attendance 
        ...
        {/* <ScrollView
          // style={{ maxHeight: 216, overflow: 'scroll' }}
          scrollEnabled={filteredStudents.length > 5}
          nestedScrollEnabled={true}
          bounces={false}
          contentContainerStyle={{ width: '100%', overflow: 'visible'  }}
        > */}
          <View style={[styles.tableWrapper]}>
            {filteredStudents.length > 0 ? (
              filteredStudents.map((student, index) => (
                <View
                  ...
                  style={[styles.tableRowLM, index % 2 === 0 ? styles.tableRowEvenLM : styles.tableRowOddLM]}
                >
 <Text style={[styles.tableCell, {flex: isMobile ? 0.6 : 0.8}]}>                    {index + 1}.
                  </Text>
                  <Text
                    style={[styles.tableCell, { flex: isMobile ? 1.2 : 1  }]}
                    accessible={true}
                  ...
                  <Text
                    style={[styles.tableCell, { flex: isMobile ? 1.8 : 1.5 }]}
                    accessible={true}
 ...
 <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 1.2 : 1,}]}>
                      {student.attendancePercentage}
                                     ...
                                     <View style={[styles.tableCell, { flex: isMobile ? 1.2 : 1, zIndex: 10 }]}>
                                                        ...
                                                        >
                                                          <Image
                                                            source={images.view}
                                                             style={[styles.emailIcon, { tintColor: '#2196F3'}]}
                                                          />
                                                        </TouchableOpacity>
                                                        </TooltipWrapper>
              ...
              <View style={styles.tableRowLM}>
                <Text style={[styles.tableCellAtt, { width: '100%'}]}>
...
>
  ...
  isMobile && { paddingHorizontal: 10 }
                    ...
                    <View style={[styles.modalContent, { width: isMobile ? '90%' : '50%' }]}>
                      <Text style={styles.modalTitle}>Send Message</Text>
             {/* Title Dropdown */}
             <View style={styles.dropdownContainer, { marginTop:9, flexDirection: isMobile? "column" : "row" , rowGap:8, justifyContent:"space-between"  }}>
 
               <Text style={[styles.modalLabel, { fontSize: isMobile ? 14 : 16, marginBottom:9}]}>Title</Text>
               <Picker
                 selectedValue={messageTitle}
                 onValueChange={(itemValue) => setMessageTitle(itemValue)}
                 style={styles.picker, {height: 28, width: isMobile ? '90%' : '40%'}}
                 itemStyle={{ fontSize: isMobile ? 14 : 16 }}
               >
             ...
             {/* </View>
             <View style={styles.dropdownContainer,{marginTop:9}}> */}
               <Text style={[styles.modalLabel, { fontSize: isMobile ? 14 : 16 }]}>Priority</Text>
               <Picker
             ...
             <View style={styles.inputContainer,{marginTop:9}}>
               <Text style={[styles.modalLabel, { fontSize: isMobile ? 14 : 16 }]}>Description</Text>
               <TextInput
                 style={[styles.modalInput, { height: 100, marginTop:9 }]}
    ...
    styles.actionButton,
    styles.saveButton,
    isMobile && { paddingHorizontal: 12, paddingVertical: 8 },
    (!messageDescription.trim()) && { opacity: 0.5 } // visually show disabled
  ]}
 
  disabled={!messageDescription.trim()}  // disable button if empty


                            // onPress={handle_MessageSendingToStudent}

                             onPress={()=>{
      setPopupAlertType_OverModal('confirmation');
      setPopupAlertTitle_OverModal('Sending Message'); // Set custom title
      ...
      setPopupAlertButtons_OverModal([
       ...
       setShowAlertPopupOverModal(true);
               ...
               >
                 <View style={[styles.modalContainer, isMobile && { paddingHorizontal: 10 }]}>
                           <View style={[styles.modalContent, { width: isMobile ? '95%' : '70%' }]}>
                             <Text style={[styles.modalTitle, { fontSize: isMobile ? 16 : 20 , alignSelf:"center"}]}>
                               Message History
                             </Text>
                             <ScrollView style={{ maxHeight: isMobile ? 300 : 400, width: '100%' }}>
                               <View style={[styles.tableWrapper]}>
                                 <View style={[styles.tableRowLM, styles.tableHeaderLM]}>
                                   ...
                                   <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 2.5 : 2}]}>
                                     Description
                                   </Text>
                                   <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 0.8 : 1 }]}>
                                     General
                                   </Text>
                                   <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 0.8 : 1 }]}>
                                     Course Specific
                                 ...
                                 {selectedStudentMessages.length > 0 ? (
                                   selectedStudentMessages.map((message, index) => (
                                     <View
                                       key={index}
                                       style={[styles.tableRowLM, index % 2 === 0 ? styles.tableRowEvenLM : styles.tableRowOddLM, isMobile && { paddingVertical: 6 }]}
                                     >
                                        <Text style={[styles.tableCell, { flex: isMobile ? 1.2 : 1 }]}>
                                                                               {message.title}
                                                                             </Text>
                                                                             <Text style={[styles.tableCell, { flex: isMobile ? 2.5 : 2 }]} numberOfLines={2} ellipsizeMode="tail">
                                                                               {message.description}
                                                                             </Text>
                                                                             <Text style={[styles.tableCell, { flex: isMobile ? 0.8 : 1}]}>
...
// //Old method  BUT new is above
// // Other helper functions
// const handleMarkNewAttendance = () => {
//   const today = new Date();
//   const existingRecord = findAttendanceRecordByDate(today);

//   if (existingRecord) {
//     alert('Attendance for today has already been recorded. You can edit the existing record.');
//     handleEditAttendance(existingRecord.AttendanceID, existingRecord.AttendanceDate);
//     return;
//   }
    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={[styles.tableContainer]}>
          <Text style={{ fontSize: isMobile ? 14 : 16 }}>No course selected</Text>
        </View>
      </View>
    );
  }
  ...
  if (showAttendanceSummary) {
    return (
      ...
      <Text style={[styles.HeaderText]}>
              Attendance Summary 
              {/* {'\n'} */}
                 {/* <Text style={{ fontSize: isMobile ? 10 : 12 , color:'grey',backgroundColor:'yellow',textAlign:'left' , width: '100%',marginLeft:10 }}>
                  (<Text style={{ fontWeight: 'bold' }}>Note :</Text> Attendance will become un-editable<Text style={{ fontWeight: 'bold',backgroundColor:'yellow' }}> {config.DaysCount_Attendance_Editable} Days</Text> after attendance date.)
                  </Text> */}
                    <Text style={styles.noteText}>
...
<TooltipWrapper tooltipText="Click to add attendance">
            <TouchableOpacity
              ...
              style={[
                styles.addLectureButton,
                Platform.OS === 'web' && !isMobile && isAddButtonHovered && styles.hoverEffect,
                // findAttendanceRecordByDate(new Date()) && { opacity: 0.5 },
                { padding: isMobile ? 8 : 10, marginTop: isMobile ? 10 : 0 }
              ]}
              onPress={() => {
                handleAddNewAttendance();
                // const existingRecord = findAttendanceRecordByDate(new Date());
                // if (existingRecord) {
                //   alert(`Attendance for ${formatDate(new Date())} already exists. Please edit the existing record.`);
                //   handleEditAttendance(existingRecord.AttendanceID, existingRecord.AttendanceDate);
                // } else {
                //   handleMarkNewAttendance();
                // }
              }}
              {...(Platform.OS === 'web' && !isMobile
                ? {
         ...
         <View style={[styles.tableWrapper]}>
                    <View style={[styles.tableRow, styles.tableHeader]}>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 1 : 0.2  }]}>S#</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 1 : 1 }]}>Date</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 1 : 1 }]}>Class Type</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, {flex: isMobile? 1 : 1}]}>Class Time</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, {flex: isMobile? 1 :  0.5 }]}>Present</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 1 :  0.5 }]}>Absent</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 1 :  0.5 }]}>Not Marked</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 1 : 1 }]}>Status</Text>
                      <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile? 2 : 1 }]}>Actions</Text>
            </View>
            {/* <ScrollView
              // style={{ maxHeight: 240 }}
                  ...
                  sortedRecords.map((record, index) => {
                   ...
                   // const CanEdit_Attendance = (isSamePerson || get_userRole === 'Admin'); //Admin OR same person Can EDIT
                    ...
                    return (
                      ...
                      >
                                                <Text style={[styles.tableCell, { flex: isMobile? 1 : 0.2}]}>{index + 1}.</Text>
                                                                        <Text style={[styles.tableCell, {flex: isMobile? 1 : 1 }]}>{formatDate(record.AttendanceDate)}</Text>
                                                                        <Text style={[styles.tableCell, { flex: isMobile? 1 : 1}]}>{record.Attendance_IsTheory?'Theory':''} {record.Attendance_IsPractical?'Practical':''} </Text>
                                                                        <Text style={[styles.tableCell, {flex: isMobile? 1 : 1  }]}>{record.Attendance_StartTime}-{record.Attendance_EndTime}</Text>
                                                                        <Text style={[styles.tableCell, { flex: isMobile? 1 : 0.5 }]}>{present}</Text>
                                                                        <Text style={[styles.tableCell, { flex: isMobile? 1 : 0.5 }]}>{absent}</Text>
                                                                        <Text style={[styles.tableCell, { flex: isMobile? 1 :  0.5 }]}>{notMarked}</Text>
                                                <Text style={[styles.tableCell, { flex: isMobile? 1: 1 }]}>  
      ...
      {!show_UnLockedSign && (
        <>
          ...
          <TouchableOpacity
            ...
            accessibilityRole="button"
            style={[styles.actionButtonLM, { padding: isMobile ? 2 : 2, marginRight: 0, opacity: 0.5 }]}
            disabled={isDisabled}
          >
            <Image
              source={images.locked}
              style={[styles.pencilIconLM, { width: isMobile ? 26 : 26, height: isMobile ? 26 : 26 }]}
            />
          </TouchableOpacity>
        </TooltipWrapper>
...
{/* {
(!isDisabled && CanEdit_Attendance) && 
<Text>I m Not disabled & Can Edit </Text>
}

{
(isDisabled && CanEdit_Attendance) && 
<Text>I m Disabled & Can Edit </Text>
}
{ (record.Attendance_IsLocked) ?  (<Text>{'\n'} I m LOCKED </Text>) : (<Text>{'\n'} I m not LOCKED </Text>)
...
(CanEdit_Attendance) ?  (<Text>{'\n'} Can Edit </Text>) : (<Text>{'\n'} Not Edit</Text>)
  ...
  { ((!isDisabled && CanEdit_Attendance) || (isDisabled && CanEdit_Attendance && !record.Attendance_IsLocked )) && (
     ...
     <TooltipWrapper tooltipText="Click to Edit Attendance">
                          <TouchableOpacity
                            ...
                            style={[styles.actionButtonLM, styles.editButtonLM, { padding: isMobile ? 6 : 6, marginRight: 4, opacity: 1 , backgroundColor:'orange' }]}
                            // disabled={isDisabled}
                          >
                            <Image source={images.pencil} style={[styles.pencilIconLM, { width: isMobile ? 16 : 16, height: isMobile ? 16 : 16 }]} />
                          </TouchableOpacity>
  ...
  <TooltipWrapper   tooltipText="Click to view attendance">
                          <TouchableOpacity
                            ...
                            style={[styles.actionButtonLM, { padding: isMobile ? 6 : 6, backgroundColor: 'orange' }]}
...
<TooltipWrapper   tooltipText="Click to submit attendance">
  ...
  //         text: 'Submit',
  //         style: 'destructive', // iOS: red tint
  //         onPress: () => handleSubmitAttendance(record.AttendanceID, 'submit'),
  //       },
  //     ],
  //     { cancelable: false } // Android: force a button tap
  //   );
  // }
                            ...
                            //style={[styles.actionButtonLM, { padding: isMobile ? 6 : 6, backgroundColor: 'orange', opacity: isDisabled ? 0.5 : 1 }]}
                            style={[styles.actionButtonLM, { padding: isMobile ? 6 : 6, backgroundColor: 'orange', opacity: 1 }]}
                            // // backgroundColor: '#ff9800'
                            // disabled={isDisabled}
                          >
                            {/* <Text style={[styles.buttonText, { fontSize: isMobile ? 10 : 12 }]}>Submit</Text> */}
...
<TooltipWrapper   tooltipText="Click to delete attendance">
 ...
 console.log('submit attendance pressed');
  ...
  //         text: 'Submit',
  //         style: 'destructive', // iOS: red tint
  //         onPress: () => handleDeleteAttendance(record.AttendanceID),
  //       },
  //     ],
  //     { cancelable: false } // Android: force a button tap
  //   );
  // }
                  ...
                  <View style={styles.tableRowLM}>
                    <Text style={[styles.tableCell, { width: '100%'}]}>No attendance records available</Text>
                  </View>
                )}
              </View>
            {/* </ScrollView> */}
    ...
    return (
      ...
      <View style={{ flex: 1 }}>
        <View style={[styles.tableContainerLM]}>
          <View style={[styles.lectureHeaderContainer, { backgroundColor: '#26A69A' }]}>
          ...
          <View style={[styles.formContainer]}>
            <View style={[styles.formRow]}>
              <View style={[styles.AddAttendancecontainer,{ width:"100%"}]}>
               
                <View style={{ flex: isMobile ? 1 : 0.25, marginBottom: isMobile ? 2 : 0 }}>
    ...
    <Text style={[styles.inputContainer, ]}>
      {date instanceof Date ? date.toLocaleDateString('en-CA') : date}
                ...
                <View style={{ flex: isMobile ? 1 : 0.2, marginBottom: isMobile ? 8 : 0 }}>
                  <Text style={[styles.formLabel]}>Start Time (HH:MM)</Text>
                  <Text style={[styles.inputContainer, ]}>
                    {startHour}:{startMinute}
                  </Text>
                </View>
                <View style={{ flex: isMobile ? 1 : 0.2 }}>
            ...
            {/* {currentRecord?.globalComments && ( */}
              <View style={[styles.commentsContainer]}>
                <Text style={[styles.commentsInput, { padding: isMobile ? 4 : 6 }]}>
                  {globalComments}
                </Text>
              </View>
            {/* )} */}
  ...
  <Text style={styles.noteText}>
    ...
    <TooltipWrapper tooltipText="Select student to enable his/her attendance">
      <TouchableOpacity
        style={[styles.submitButton, { backgroundColor: 'green', marginRight: 9  }]}
...
////////////////////////////////
        ...
        //     //Fetch current selected Attendance ID
        //     //Make attendance detail as isEditable=1
        //     //Make attendance islocked=0

        //     //BUT upon Edit & submit 
        //        //Make attendance detail as isEditable=0
        //        //Make attendance islocked=1
        ...
        //     ]);
        //     setShowAlertPopup(true);
        //     // Optionally reset selectedStudents or navigate back
        //     // setSelectedStudents([]);
        //     // setShowSelectStudentsTable(false);
        //     // setShowAttendanceSummary(true);
          ...
          >
            <View style={[styles.tableWrapper]}>
              <View style={[styles.tableRowLM, styles.tableHeaderLM, { width: isMobile ? 650 : '100%' }]}>
                ...
                <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 0.5 : 0.4 }]}>Reg. No.</Text>
                <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 1.2 : 1 }]}>Students</Text>
                ...
                <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 0.5 : 0.4 }]}>Status</Text>
              ...
              <ScrollView
                ...
                nestedScrollEnabled={true}
                bounces={false}
                contentContainerStyle={{ width: isMobile ? 650 : '100%' }}
              >
                <View style={[styles.tableWrapper]}>
    ...
    >
      {selectedStudents.includes(student.id) && (
        <View style={[styles.checkboxInner, { width: isMobile ? 10 : 14, height: isMobile ? 10 : 14 }]} />
      )}
    </TouchableOpacity>
  {/* </View> */}
                        </View>
                        <Text style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.4 }]}>{student.id}</Text>
                        <Text style={[styles.tableCell, { flex: isMobile ? 1.2 : 1 }]}>
                          {student.name} ({student.attendancePercentage || '0%'})
                        </Text>
                       
                       
                        <Text style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.4, fontSize: isMobile ? 10 : 16 }]}>
                    ...
                    <View style={styles.tableRowLM}>
                      <Text style={[styles.tableCell, { width: '100%', fontSize: isMobile ? 14 : 16 }]}>No students enrolled</Text>
                    </View>
                  )}
                </View>
              </ScrollView>
...
//    const isAttendance_Locked = currentRecord?.attendance_IsLocked || false;
//         //Make sure it is NOT view then Disable = false
//         // 
//         let DecisionToDisable_Previous=(mode === 'View' || isSubmitted);
//         let DecisionToDisable=false;

//         if (mode === 'View') {
//           DecisionToDisable = true;
//          } 
//          else if (isSubmitted && isAttendance_Locked) {
//            DecisionToDisable = true;
//          } 
//          else {
//            DecisionToDisable = false;
//          }
      ...
      <View style={[styles.tableContainerLM]}>
        <View style={[styles.lectureHeaderContainer, { backgroundColor: '#26A69A' }]}>
          ...
          <View style={[styles.formContainer]}>
                  <View style={[styles.formRow]}>
                    <View
                      style = {[styles.AddAttendancecontainer, {width:"100%"}
              ...
              {Platform.OS === 'web' ? (
                ...
                <>
                  ...
                  >
                    <TextInput
                                                                  style={[styles.inputContainer, { padding: isMobile ? 8 : 12,
                                                                  } ]}
  ...
  {/* {(Allow_Edit_AttendanceDetail)?  '\n Fk Allowed Edit' : '\n FK Not Allowed'} */}
        ...
        <View style={[styles.tableWrapper]}>
                            <View style={[styles.tableRowLM, styles.tableHeaderLM, { width: isMobile ? 600 : '100%' }]}>
                              <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 0.5 : 0.4, }]}>Reg. No.</Text>
                              <Text style={[styles.tableCell, styles.tableHeaderText, { flex: isMobile ? 1.2 : 1,  }]}>Students</Text>
                              <View style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.4, flexDirection: 'row', alignItems: 'center' }]}>
                                <Text style={[styles.tableHeaderText, { flex: isMobile ? 0.3 : 0.2,  }]}>Present</Text>
                       
                       <TooltipWrapper tooltipText="Click to make all present">
                        <TouchableOpacity
                          style={[styles.radioButton, styles.selectAllButton, { width: isMobile ? 16 : 20, height: isMobile ? 16 : 20 }]}
                          onPress={() => handleSelectAll('Present')}
                          accessible={true}
                          accessibilityLabel="Select all Present"
                          disabled={Disable_ViewMode_OR_Submitted}
                        >
                          <View style={[styles.radioButtonSelected, { width: isMobile ? 12 : 16, height: isMobile ? 12 : 16 }]} />
                        </TouchableOpacity>
                        </TooltipWrapper>
                      </View>
                       <View style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.4, flexDirection: 'row', alignItems: 'center' }]}>
    ...
    (mode !== 'View' && student.isEditable && MainAttendance_isDisabled && MainAttendance_show_UnLockedSign) && { backgroundColor: '#d4edda' } // light green
     ...
     >
                              <Text style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.5,  }]}>{student.id}
                               
                               
                               {/* {'\n'} Main Submitted : {(MainAttendance_isSubmitted)?  'Yes':'No'}
                               {'\n'} FK Main Edit : {(Allow_Edit_AttendanceDetail)?  'Yes':'No'}
                               {'\n'} Student editable : {(student.isEditable)? 'Yes':'No'} */}
                               
                               {/* {'\n'} Previous Decision :  {   (DecisionToDisable_Previous)? 'yes disable':'no disable'}
                               {'\n'} New Decision : {   (DecisionToDisable)? 'yes disable':'no disable'}
                                */}


                              </Text>
                                                            <Text style={[styles.tableCell, { flex: isMobile ? 1.2 : 1,  }]}>{student.name} ({student.attendancePercentage || '0%'})</Text>
                                                            <View style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.5, justifyContent: 'center', alignItems: 'center' }]}>
                                <TouchableOpacity
                                  style={[styles.radioButton, student.status === 'Present' && styles.radioButtonSelected, { width: isMobile ? 16 : 20, height: isMobile ? 16 : 20 }]}
    ...
    if (
      ...
      handleStatusChange(student.id, 'Present');
                                ...
                                >
                                  ...
                                  {student.status === 'Present' && <View style={[styles.radioButtonInner, { width: isMobile ? 8 : 12, height: isMobile ? 8 : 12 }]} />}
                                </TouchableOpacity>
                              ...
                              <View style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.5, justifyContent: 'center', alignItems: 'center' }]}>
                                <TouchableOpacity
                                  style={[styles.radioButton, student.status === 'Absent' && styles.radioButtonSelected, { width: isMobile ? 16 : 20, height: isMobile ? 16 : 20 }]}
    ...
    if (
      ...
      handleStatusChange(student.id, 'Absent');
                                ...
                                >
                                  {student.status === 'Absent' && <View style={[styles.radioButtonInner, { width: isMobile ? 8 : 12, height: isMobile ? 8 : 12 }]} />}
                                </TouchableOpacity>
                              </View>
                              <Text style={[styles.tableCell, { flex: isMobile ? 0.5 : 0.5, fontSize: isMobile ? 10 : 16 }]}>{student.status || 'Not Set'}</Text>
                              <TextInput
                                style={[styles.tableCellComments, { fontSize: isMobile ? 10 : 14, padding: isMobile ? 4 : 6 }]}
...
const renderTabs = () => (
  <View style={[styles.tabContainer, { width: isMobile ? '98%' : '80%', marginTop: isMobile ? 12 : 0 }]}>
    {isMobile ? (
          <ScrollView
            horizontal
